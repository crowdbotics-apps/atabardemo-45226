"""
Django settings for atabardemo_45226 project.
...
ROOT_URLCONF = 'atabardemo_45226.urls'
...
WSGI_APPLICATION = 'atabardemo_45226.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "atabardemo_45226 API",
    "DESCRIPTION": "API documentation for atabardemo_45226 App",
    "VERSION": "v1",
}
